...
use jc\MovieQuizzBundle\Form\QuizzType;
...
class QuizzBOController extends Controller {
    ...
    /**
     * @Route("/admin/movie-quizz/list", name="jc_movie_quizz_bo_list")
     */
    public function listQuizzAction(Request $request) {
        ...
        return $this->render('jcMovieQuizzBundle:BO:listQuizz.html.twig', array('quizzList' => $quizzList));
    }

    /**
     * @Route("/admin/movie-quizz/create", name="jc_movie_quizz_bo_create")
     */
    public function createQuizzAction(Request $request) {
        ...
        try {
            ...
            $redirectUrl = $this->generateUrl('jc_movie_quizz_bo_edit', array('id' => $id));
    ...
    /**
     * @Route("/admin/movie-quizz/edit/{id}", requirements={"id" = "\d+"}, name="jc_movie_quizz_bo_edit")
     */
    public function editQuizzAction(Request $request, $id) {
        ...
        return $this->render('jcMovieQuizzBundle:BO:editQuizz.html.twig', array('quizzToEdit' => $form->createView()));
    }

    /**
     * @Route("/admin/movie-quizz/delete/{id}", requirements={"id" = "\d+"}, name="jc_movie_quizz_bo_delete")
     */
    ...
    private function processUpload($quizz) {
        ...
        if (null !== $quizz->getPictureFile()) {
            ...
            $relativeFolderPath = $this->getParameter('jc_movie_quizz.root_path');
