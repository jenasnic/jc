 ...
 */
class EnglishExpressionRepository extends EntityRepository implements CommonEnglishItemRepository {
    ...
    public function getItemExcludingIds($idList, $lesson = 0) {
        ...
        try {
            ...
            $query = $this->_em->createQuery('SELECT i FROM jcEnglishQuizzBundle:EnglishExpression i ' . $condition);
    ...
    public function countItem($lesson = 0) {
        ...
        try {
            ...
            $query = $this->_em->createQuery('SELECT count(i) FROM jcEnglishQuizzBundle:EnglishExpression i ' . $condition);
    ...
    public function searchItem($property, $value) {
        ...
        try {
            ...
            $query = $this->_em->createQuery('SELECT i FROM jcEnglishQuizzBundle:EnglishExpression i WHERE i.' . $property . ' LIKE \'%' . $value . '%\'');
            return $query->getResult();
        }
        catch(\Exception $ex) {
            return array();
    ...
    public function getLessonList() {
        ...
        try {
            ...
            $query = $this->_em->createQuery('SELECT distinct i.lesson FROM jcEnglishQuizzBundle:EnglishExpression i WHERE i.lesson <> 0 ORDER BY i.lesson ASC');
